 ...
 * Prorates - https://stripe.com/docs/billing/subscriptions/upgrade-downgrade#changing
 */
...
const createSourceForCustomer = async function (customer_id, source_id) {
...
const createCustomerSubscription = async function (paymentInformation) {
  ...
  if (customer) {
    ...
    throw Error(
      `The customer ${paymentInformation.customerId} does not exist, createCustomerSubscription()`
    );
  }
};
